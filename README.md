...
ในกรณีนี้ vector มี 200 มีติ สัมประสิทธิ์ก็มีทั้งหมด 200^2 (A) + 200 (b) = 40200 ตัว แต่เก็บตัวอย่างมากขนาดนั้นไม่ได้ เพราะฉะนั้นต้องการ regression model อะไรสักอย่าง
