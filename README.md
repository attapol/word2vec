...
| 'เกาหลีเหนือ' + 'ซามูไร' - 'ญี่ปุ่น' | ('โสมแดง', 0.6188918948173523) ... | ('โสมแดง', 0.6945276260375977) ... |
| 'ญี่ปุ่น' + 'ไก่งวง' - 'ตุรกี' | ('ปลาดิบ', 0.5589873790740967) ... | ('ปลาดิบ', 0.6096704006195068) ... |

##### 3.1.2.2 วิธี 2 ค้นหา country
|สูตร|CBOW |Skip-gram |
|:-:|:-:|:-:|
|'มะกะโรนี' + 'ญี่ปุ่น' - 'ปลาดิบ' | ('อิตาลี', 0.5933549404144287) ... | ('อิตาลี', 0.7145664691925049) ... |
|'จิงโจ้' + 'เกาหลีใต้' - 'กิมจิ' | ('ไต้หวัน', 0.5936126708984375) ('ออสเตรเลีย', 0.5897310376167297) ... | ('ออสเตรเลีย', 0.6734793186187744) ... |
|'กีวี' + 'จีน' - 'มังกร' | ('นิวซีแลนด์', 0.5326523780822754) ... | ('นิวซีแลนด์', 0.6551463603973389) ... |
|'อิเหนา' + 'ญี่ปุ่น' - 'ซามูไร' | ('สิงคโปร์', 0.626672625541687) ('อินโดนีเซีย', 0.6032019853591919) ... | ('อินโดนีเซีย', 0.7172484397888184) ... | 
