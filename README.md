...
|| CBOW | skip-gram |
|:-:|--:|--:|
|detA (product of eigenvalue A<sub>i,i</sub>)| ~0 | ~0 |
...
|ญี่ปุ่น : ปลาดิบ (skip-gram) | 0.8144|0.831|0.7586 |
...
|ญี่ปุ่น : อาทิตย์อุทัย (CBOW) |0.5913|0.823|0.8897 |
|ญี่ปุ่น : อาทิตย์อุทัย (skip-gram) |0.7926|0.8039|0.7974 |
|จีน : มังกร (CBOW)|0.515|0.705|0.997 |
...
|อังกฤษ : ผู้ดี (CBOW)|0.762|0.8534|0.9984 |
...
|ออสเตรเลีย : จิงโจ้ (CBOW)|0.646|0.8194|0.9935 |
